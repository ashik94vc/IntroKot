package ttl.introkot.larku.service.fancy.inheritance
 ...
 * @author whynot
 */
class SerialStatefulStudentServiceTest {

    lateinit var studentService: StudentService

    val fileName = "/tmp/fancyserial.ser"
    @BeforeEach
    fun init() {
        studentService = DAOFactory.serialStatefulStudentService(fileName)
